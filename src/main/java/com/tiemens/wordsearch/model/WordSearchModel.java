...
//            }
    ...
    public static class RowCol {
        ...
        public RowCol computeDirection(Direction direction, RowCol maxCoord) {
    ...
    public static class WordSearchGrid extends com.tiemens.socialsecurity.math.Matrix<String> {
